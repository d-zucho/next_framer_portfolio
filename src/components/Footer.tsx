    ...
    <footer className='w-full pt-20 pb-20' id='contact'>
      ...
      <div className='flex flex-col items-center'>
        <h1 className='heading lg:max-w-[45vw]'>
          ...
          outside digital presence to the next level
        </h1>
        ...
        <a href='mailto:danny.nicodev@gmail.com'>
          <MagicButton
      ...
      <div className='flex mt-16 md:flex-row flex-col justify-between items-center gap-4 md:gap-0'>
        ...
        <div className='flex items-center md:gap-3 gap-6'>
          {socialMedia.map((profile) => (
            <div
              key={profile.id}
              className='w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300'
            >
